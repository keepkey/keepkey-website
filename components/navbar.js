...
export default function Navbar() {
  ...
  return (
     <nav className={`nav fixed w-full pb-3 z-10 transition-all pt-4 ease-in-out duration-400 ${scroll ? 'bg-black lg:pt-8' : 'lg:pt-4'} ${isActive ? 'nav--is-open' : ''}`}>
      <div className="container mx-auto flex flex-wrap items-center">
        ...
        <Link href="/community">
          <a className="hidden lg:block transition-opacity text-white text-base px-4 xl:px-8 font-normal opacity-80 hover:opacity-100">Community</a>
        </Link>
        <Link href="/supported-applications">
          <a  className="hidden lg:block transition-opacity text-white text-base px-4 xl:px-8 font-normal opacity-80 hover:opacity-100">Supported Applications</a>
        </Link>
        <Link href="/integration-guide">
          <a  className="hidden lg:block transition-opacity text-white text-base px-4 xl:px-8 font-normal opacity-80 hover:opacity-100">Integration Guide</a>
        </Link>
        <Link href="/onboarding">
          <a className="hidden lg:block transition-opacity text-white text-base px-4 xl:px-8 font-normal opacity-80 hover:opacity-100">Onboarding</a>
        </Link>
        <div className="ml-auto flex align-center">
          <div className="hidden sm:inline-block mr-8">
    ...
    <>
      ...
      <div aria-hidden="false" className="nav-mobile__menu lg:hidden" role="menu">
        <ul className="nav-mobile__category-wrapper">
          <li className="nav-mobile__category-item nav-mobile__category-line">
