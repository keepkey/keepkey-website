            ...
            <div className="container grid gap-y-24 md:gap-y-48">
                ...
                <div className="grid md:grid-cols-2 gap-y-10 gap-x-24 lg:gap-32">
                    <div className="self-center order-1 md:order-none">
                        ...
                        <text>
                        <p>
IMPORTANT UPDATE: Due to COVID-19 related circumstances, we have had to temporarily restrict orders to some countries. International Service Suspensions from USPS can be found here.
