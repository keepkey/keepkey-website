...
import SlimLayout from "../components/layout-slim";
...
export default ({ children }) => (
  <SlimLayout meta={meta} heroBgImg={heroBgImg} pageTitle={meta.pageTitle}>
    {children}
  </SlimLayout>
);
...
<br/>
**Contact.** 
 Please contact us by submitting a request to us at [https://keepkey.zendesk.com/hc/en-us/requests/new](https://keepkey.zendesk.com/hc/en-us/requests/new) with any questions regarding these Terms.
