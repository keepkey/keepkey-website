    ...
    return (
        <section>
            <div className="container grid ">
                        ...
                        <p className="my-6"></p>
                        <br/>
                        At KeepKey, we take security seriously. We encourage independent security
                        ...
                        to the KeepKey security team.
                        <br/>
                        <br/>
                        If you would like to disclose a vulnerability to KeepKey, we encourage you
                        to send a new email to security@keepkey.com with the word **[VULNERABILITY]** in
                        the subject line.
                        <br/>
